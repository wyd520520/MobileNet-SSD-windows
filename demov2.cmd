...
set in_dir=data\
set wait_time=1
scripts\build\examples\ssd\Release\ssd_detect models\MobileNetV2\deploy_voc_retrain_deploy.prototxt ^
models\MobileNetV2\MobileNetSSD_deploy_iter_27000.caffemodel ^
%in_dir% ^
-file_type video ^
